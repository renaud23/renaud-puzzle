...
public class TapisZoomController extends AbstractTapisController{
	...
	public TapisZoomController(Image background,Fenetre fenetre, Tapis tapis) {
		...
		this.tapisDrawer = new TapisZoomDrawer(fenetre,background,tapis,fenetre.getBuffer(0),this.converter);
		...
		this.selectionDrawer = new DrawZoomSelection(this.fenetre.getBuffer(1), (TapisZoomConverteur) this.converter);
