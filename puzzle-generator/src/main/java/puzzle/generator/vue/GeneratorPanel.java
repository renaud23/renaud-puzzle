...
public class GeneratorPanel extends JPanel 
	...
	private GeneratorPanel(){
		...
		this.genereButton = new JButton("G�nerer!");
		...
		this.createZone("Nombre de pi�ces en largeur :", this.widthSpinner);
		this.createZone("Nombre de pi�ces en hauteur :",this.heightLabel);
		this.createZone("Nombre total de pi�ces :",this.nbPiecesLabel);
		this.createZone("Scale des pi�ces :",this.choixScale);
		this.createZone("Jeu de pi�ces utilis�es :",this.choixSetPieces);
